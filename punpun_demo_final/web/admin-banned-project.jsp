<%--
    Document   : admin-banned-project
    Created on : May 28, 2017, 11:58:24 PM
    Author     : kanok
--%>
                    ...
                    <div class="sidebar-container">
                        ...
                        <nav class="menu">
                            <ul class="nav metismenu" id="sidebar-menu">
                                ...
                                <li class="active"> <a href="admin-banned-project.jsp">         <i class="fa fa-ban"></i> โครงการที่ถูกระงับ </a></li>
                            </ul>
                        </nav>
                        ...
                        <ul class="item-list striped">
                            ...
                            <li class="item item-list-header hidden-sm-down">
                                <div class="item-row">
                                    ...
                                    <div class="item-col item-col-header item-col-stats">
                                        <div > <span> จำนวนครั้งที่ถูกรายงาน </span> </div>
                                    </div>
                                </div>
                            </li>
