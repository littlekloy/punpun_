<%--
    Document   : admin-reported-project
    Created on : May 29, 2017, 12:10:32 AM
    Author     : kanok
--%>
                    ...
                    <div class="sidebar-container">
                        ...
                        <nav class="menu">
                            <ul class="nav metismenu" id="sidebar-menu">
                                ...
                                <li class="active">                <a href="admin-reported-project.jsp">    <i class="fa fa-exclamation-triangle"></i> โครงการที่ถูกรายงาน </a></li>
                ...
                <article class="content items-list-page">
                    ...
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> โครงการที่ถูกรายงาน </h3>
